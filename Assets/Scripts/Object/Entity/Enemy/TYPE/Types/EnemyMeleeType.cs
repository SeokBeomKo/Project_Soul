...
namespace EnemySystem
{
    public class EnemyMeleeType : Enemy
    {
        ...
        public override void Battle()
        {
            ...
            pathTiles = AStarAlgorithm.FindPath(GameManager.Instance.nodeMap, Vector2Int.FloorToInt(new Vector2(transform.parent.position.x,transform.parent.position.z)), targetTile.Value);
